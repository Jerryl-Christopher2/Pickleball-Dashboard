...
def inject_apple_design_system():
    """A single CSS pass giving the whole app an Apple-style look: system
    font stack, a light neutral background with white "surface" cards,
    Apple's blue accent, pill-shaped buttons and segmented-control-style
    radios, rounded/softly-shadowed inputs and data tables, and a cleaner
    sidebar. Every page gets this automatically — no page-by-page markup
    changes needed."""
    st.markdown(
        """
        <style>
        ...
        p, li, .stMarkdown, div[data-testid="stCaptionContainer"] {
            color: var(--apple-text);
        }
        div[data-testid="stCaptionContainer"] { color: var(--apple-text-secondary) !important; }
        ...
        div[data-testid="stButton"] > button:hover, div[data-testid="stFormSubmitButton"] > button:hover {
            border-color: var(--apple-text-secondary) !important;
